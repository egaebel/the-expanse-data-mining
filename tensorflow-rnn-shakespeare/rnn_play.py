...
# should_be_best = "checkpoints/rnn_train_1521435853-54000000"
slightly_older = "checkpoints/rnn_train_1521435853-33000000"
author = slightly_older

ncnt = 0
with tf.Session() as sess:
    new_saver = tf.train.import_meta_graph('checkpoints/rnn_train_1521435853-45000000.meta')
